...
NTSTATUS HookSSDT()
{
	...
	if(g_pMdlSystemCall)
	{
		...
		HOOK_SYSCALL(ZwOpenProcess, MyZwOpenProcess, g_funOrigZwOpenProcess, _ZwOpenProcess);
		//g_funOrigZwOpenProcess = (ZWOPENPROCESS)InterlockedExchange(GET_FUN_FOR_MAPPED(ZwOpenProcess), (ULONG)_MyFun);
